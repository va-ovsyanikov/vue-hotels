    ...
    <div class="modal_side modal_right">
                <div class="modal_side_wrap">
                    <div class="modal_head modal_head_tarif">
                        ...
                        <div class="tarif_switch tabs tabs-but" v-if="segments">
                            <a href="#" :class="{'active': indexItem === index }" class="swit_tarif1" v-for="(item, index) in segments" @click="showSection(item.PaxSegmentID, index)" :key="index">{{ item.Dep.IATA_LocationCode }} </a>
                        </div>
                    ...
                    <div class="rules_wrap">
                        <div class="rules_item" v-if="sections">
...
onMounted(async ()=>{
    try {
        ...
        segments.value = response.data.PaxSegmentList.PaxSegment
